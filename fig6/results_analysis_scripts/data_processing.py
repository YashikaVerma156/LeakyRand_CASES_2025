...
if len(sys.argv) != 3:
    print("Two commandline arguments are expected i.e 1 if the training_dataset results are processed or 0 if the testing_dataset results are processed.")
    print("The err_corr_iterations. Exiting...")
    sys.exit(1)
...
err_corr_iterations=int(sys.argv[2])  #Maximum number of times error-correction can be repeated.

UFs=[16]
#Algo_trigger_point=[512, 256, 128, 64, 32, 16, 8]
Algo_trigger_point=[128]
#Algo_trigger_point=[256]
string_len=512
    ...
    for atp in Algo_trigger_point:
        ...
        with open(tot_err_cnt_file_path, "r") as file:
            ...
            with open(text_file, 'w') as txtfile:
                ### Calculating bandwidth with both algorithms.
                ...
                ### Calculating bandwidth with hole-filling only.
