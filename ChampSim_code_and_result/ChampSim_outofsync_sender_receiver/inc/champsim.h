...
#define ALGO_TRIGGER_POINT 0

#define PERCNT_REC_ARR 0

#define PERCNT_DATA_BIT 0

#define MAX_EXTRA_BLOCKS_POSSIBLE 1

#define DONT_PROBE_COMPLETE 0
...
extern uint64_t sender_evicted_own_active_block, sender_evicted_own_inactive_block, sender_evicted_receiver_inactive_block, sender_evicted_receiver_nonrecognizable_active_block, sender_evicted_receiver_recognizable_active_block, sender_filled_up_empty_block, probe_stopping_point;
...
extern int Calculate_LLC_occupancy, DONT_INC_ARR, received_bit_number, dont_probe_complete;
