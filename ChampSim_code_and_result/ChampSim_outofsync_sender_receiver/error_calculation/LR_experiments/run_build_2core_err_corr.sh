...
sed -i.bak 's/\<ALGO_TRIGGER_POINT 0\>/ALGO_TRIGGER_POINT '${do_err_corr_at}'/g' inc/champsim.h
...
sed -i.bak 's/\<ALGO_TRIGGER_POINT '${do_err_corr_at}'\>/ALGO_TRIGGER_POINT 0/g' inc/champsim.h
