...
percentage_receiver_arr=$9 
percentage_data_bits=${10}
dont_probe_complete=${11}
...
# Check if exactly ten arguments are passed
if [ "$#" -ne 11 ]; then
...
sed -i.bak 's/\<PERCNT_REC_ARR 0\>/PERCNT_REC_ARR '${percentage_receiver_arr}'/g' ../../inc/champsim.h
sed -i.bak 's/\<PERCNT_DATA_BIT 0\>/PERCNT_DATA_BIT '${percentage_data_bits}'/g' ../../inc/champsim.h
sed -i.bak 's/\<DONT_PROBE_COMPLETE 0\>/DONT_PROBE_COMPLETE '${dont_probe_complete}'/g' ../../inc/champsim.h
...
path_to_copy_trace=/home/yashikav/Desktop/Mirage_project/ChampSim_outofsync_sender_receiver/error_calculation/LR_experiments/pin_traces
back_to_exp_dir=../../../../../ChampSim_outofsync_sender_receiver/error_calculation/LR_experiments
Result_dir=/home/yashikav/Desktop/Mirage_project/ChampSim_outofsync_sender_receiver/error_calculation/LR_experiments/results
...
then
    ...
    sed -i.bak 's/\<PERCNT_REC_ARR '${percentage_receiver_arr}'\>/PERCNT_REC_ARR 0/g' ../../inc/champsim.h
    sed -i.bak 's/\<PERCNT_DATA_BIT '${percentage_data_bits}'\>/PERCNT_DATA_BIT 0/g' ../../inc/champsim.h
    sed -i.bak 's/\<DONT_PROBE_COMPLETE '${dont_probe_complete}'\>/DONT_PROBE_COMPLETE 0/g' ../../inc/champsim.h
...
./run_build_2core_err_corr.sh ${sim_count_sender} ${trace_receiver} ${trace_sender} ${seed} ${string_size} ${extra} ${extra_for_llc_occ_chk} ${start_arr_addr} ${max_arr_len} ${extra_arr_max_addr} ${path_to_copy_trace} ${Result_dir} ${do_err_corr_at} 
