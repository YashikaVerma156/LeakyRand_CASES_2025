...
percentage_receiver_arr=${12} 
percentage_data_bits=${13}
dont_probe_complete=${14}
...
./script_for_err_corr_both_algo_2core_sender_access_and_flush_multiple_blocks_multiple_algo_itr_optimized.sh ${benchmark_test} ${arr_size} ${unroll_fact} ${algo_trigger_point} ${other_blocks} ${END_POINT} ${hit_miss_threshold} ${err_corr_iterations} ${percentage_receiver_arr} ${percentage_data_bits} ${dont_probe_complete}
...
result_dir=/home/yashikav/Desktop/Mirage_project/ChampSim_outofsync_sender_receiver/error_calculation/LR_experiments/LR_ERR_CORR_2core_results_both_algo_${err_corr_iterations}_access_${percentage_receiver_arr}_${percentage_data_bits}_${dont_probe_complete}
...
do
    ...
    do
            ...
            receiver_trace_path=/home/yashikav/Desktop/Mirage_project/ChampSim_outofsync_sender_receiver/error_calculation/LR_experiments/pin_traces/${receiver_trace}
            ...
            sender_trace_path=/home/yashikav/Desktop/Mirage_project/ChampSim_outofsync_sender_receiver/error_calculation/LR_experiments/sender_err_corr_both_algo_sender_access_and_flush_multiple_blocks/${sender_trace}
