...
if int(sys.argv[2]) != 97 and int(sys.argv[2]) != 95 and int(sys.argv[2]) != 92:
    print("The value should be 92, 95 or 97.")
    sys.exit(1)
...
directory_name = 'extracted_results_'+str(err_corr_iterations)+'_'+str(non_probe_arr_prcnt)+'_'+str(prcnt_bits_with_non_probe_arr_prcnt)
...
res_dir_path= 'extracted_results_'+str(err_corr_iterations)+'_'+str(non_probe_arr_prcnt)+'_'+str(prcnt_bits_with_non_probe_arr_prcnt)
            ...
            for line_number, line in enumerate(file, start=1):
                ...
                if(line_number == 2):
                    ...
                    if(int(line[11]) < int(min_algo2)):
                        ...
                        #exit(1)
            text_file='Total_result_'+str(UF)+'_train_'+str(train_data)+'_'+str(atp)+'_with_err_corr_both_algo_'+str(err_corr_iterations)+'_access_other_blocks_'+str(other_blocks)+'_'+str(non_probe_arr_prcnt)+'_'+str(prcnt_bits_with_non_probe_arr_prcnt)+'.txt'
