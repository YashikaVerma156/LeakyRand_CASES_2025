...
sed -i.bak 's/\<NOISE_TRIGGER_POINT 0\>/NOISE_TRIGGER_POINT '${noise_trigger_point}'/g' ../../inc/champsim.h
...
path_to_copy_trace=/home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_noise_sensitivity_study_LR/error_calculation/LR_experiments/pin_traces
back_to_exp_dir=../../../../../ChampSim_for_mirage_noise_sensitivity_study_LR/error_calculation/LR_experiments
Result_dir=/home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_noise_sensitivity_study_LR/error_calculation/LR_experiments/results
...
then
    ...
    sed -i.bak 's/\<NOISE_TRIGGER_POINT '${noise_trigger_point}'\>/NOISE_TRIGGER_POINT 0/g' ../../inc/champsim.h
...
./run_build_2core_err_corr.sh ${sim_count_sender} ${trace_receiver} ${trace_sender} ${seed} ${string_size} ${extra} ${extra_for_llc_occ_chk} ${start_arr_addr} ${max_arr_len} ${extra_arr_max_addr} ${path_to_copy_trace} ${Result_dir} ${noise_trigger_point} &
