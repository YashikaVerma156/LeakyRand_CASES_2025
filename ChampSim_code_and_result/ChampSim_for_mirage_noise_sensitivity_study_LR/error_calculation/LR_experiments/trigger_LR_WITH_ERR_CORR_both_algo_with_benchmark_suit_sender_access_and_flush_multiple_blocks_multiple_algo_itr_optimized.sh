...
./script_for_err_corr_both_algo_2core_sender_access_and_flush_multiple_blocks_multiple_algo_itr_optimized.sh ${benchmark_test} ${arr_size} ${unroll_fact} ${algo_trigger_point} ${other_blocks} ${END_POINT} ${hit_miss_threshold} ${err_corr_iterations} ${noise_trigger_point}
...
result_dir=/home/yashikav/Desktop/Mirage_project/fig7/champsim_results/LR_ERR_CORR_2core_results_both_algo_${err_corr_iterations}_access
...
do
    ...
    do
            ...
            receiver_trace_path=/home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_noise_sensitivity_study_LR/error_calculation/LR_experiments/pin_traces/${receiver_trace}
            ...
            sender_trace_path=/home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_noise_sensitivity_study_LR/error_calculation/LR_experiments/sender_err_corr_both_algo_sender_access_and_flush_multiple_blocks/${sender_trace}

            ./run_2core_LR_ERR_CORR_both_algo.sh $sim_count $receiver_trace_path $sender_trace_path $seed $string_size $result_dir $binary_path ${noise_trigger_point} &
