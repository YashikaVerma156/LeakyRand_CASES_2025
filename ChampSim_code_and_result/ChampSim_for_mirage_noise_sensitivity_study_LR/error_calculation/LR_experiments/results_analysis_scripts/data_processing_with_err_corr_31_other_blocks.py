...
directory_name = 'extracted_results_'+str(noise_trigger_point)
...
directory_path='../LR_ERR_CORR_2core_results_both_algo_100_access'

res_dir_path='extracted_results_'+str(noise_trigger_point)
