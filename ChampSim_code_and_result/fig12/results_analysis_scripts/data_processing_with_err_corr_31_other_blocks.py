...
string_len=512
#err_corr_iterations=18 #Maximum number of times error-correction can be repeated.
...
for UF in UFs:
    for atp in Algo_trigger_point:
        if other_blocks == 652:
            err_corr_iterations=15 #Maximum number of times error-correction can be repeated.
        elif other_blocks == 163:
            err_corr_iterations=17 #15 #17 #Maximum number of times error-correction can be repeated.
        elif other_blocks == 326:
