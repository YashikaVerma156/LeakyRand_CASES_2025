...
mkdir -p /home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_fa_lru_multithreaded_receiver_with_coherence_details/fa_lru_covert_channel/results_with_helper_core
