...
extern int bit_number_received;   // Used in setting up the HIT_MISS_THRESHOLD separately for data bits and marker bits in LR.
extern uint32_t HOLE_FILLING_BIT, LLC_OCC_CHK_BIT;
