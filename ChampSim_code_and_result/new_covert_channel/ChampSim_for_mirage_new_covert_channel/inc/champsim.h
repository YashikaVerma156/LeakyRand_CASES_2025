...
#define HIT_MISS_THRESHOLD_SINGLE_ARR_ACCESS 65
...
#define NEW_COVERT_CHANNEL 0

#define NEW_COVERT_CHANNEL_LR_PROBE 0

#define CACHE_REGION_IDENTIFICATION 0 
...
extern int EVICTED_CPU, // values can be -1(no eviction), 0(block of cpu0 is evicted), or 1(block of cpu1 is evicted).
           ...
           rdtsc_timer_is_on,
           inside_rdtsc;
extern int CURR_ERR_CORR_ITR, MISSES_OBSERVED, CURR_LLC_OCC_CHK_ITR, NUM_CHUNKS_WITH_MISSES;
...
extern uint64_t sender_evicted_own_active_block, sender_evicted_own_inactive_block, sender_evicted_receiver_inactive_block, sender_evicted_receiver_nonrecognizable_active_block, sender_evicted_receiver_recognizable_active_block, sender_filled_up_empty_block, misses_in_a_chunk;
...
extern uint64_t seen_first_rdtsc;
