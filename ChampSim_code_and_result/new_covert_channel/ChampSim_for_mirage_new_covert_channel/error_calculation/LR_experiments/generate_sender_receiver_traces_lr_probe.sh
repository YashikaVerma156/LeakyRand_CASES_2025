...
result_dir=/home/yashikav/Desktop/Mirage_project/new_covert_channel/ChampSim_for_mirage_new_covert_channel/error_calculation/LR_experiments/NEW_COV_CH_2core_LR_PROBE_${sen_dis}

mkdir -p NEW_COV_CH_2core_LR_PROBE_${sen_dis}
...
do
		cd ${pin_files_path}
		./commands_sender_new_covert_channel.sh ${sen_dis} ${string_size} ${string_num} ${path_to_copy_trace} ${benchmark_test}
