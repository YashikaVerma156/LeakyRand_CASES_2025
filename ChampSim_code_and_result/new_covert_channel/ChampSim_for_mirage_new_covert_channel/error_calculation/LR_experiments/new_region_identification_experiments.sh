...
Total_iterations=$(( $num_repeat + $mid_repeat1 + $mid_repeat2))

######### 1. Generate pintrace for sender
cd ${pin_files_path} 
./commands_changed_cache_region_identification.sh ${num} ${mid_repeat1} ${mid_repeat2} ${num_repeat} ${path_to_copy_trace} ${mid_number1} ${mid_number2} ${arr_size_probed}
...
trace=champsim.trace_${num}_dynamic_strategy_${mid_number1}_${mid_repeat1}_${mid_number2}_${mid_repeat2}_${num}_${num_repeat}_probe_${arr_size_probed}.gz
echo "$trace"
#exit
