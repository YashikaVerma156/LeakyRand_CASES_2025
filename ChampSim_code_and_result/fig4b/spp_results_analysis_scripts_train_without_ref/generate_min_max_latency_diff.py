...
sender_arr_sizes=[3276, 6554, 9830, 13108, 16380]
msg_size=512
...
for arr_size in sender_arr_sizes:
        ...
        print("sender_arr_size: ",sender_array_size," min_bit0: ",min_bit0," max_bit0: ",max_bit0," min_bit1: ",min_bit1," max_bit1: ",max_bit1)
        new_data="sender_arr_size: "+str(sender_array_size)+" min_bit0: "+str(min_bit0)+" max_bit0: "+str(max_bit0)+" min_bit1: "+str(min_bit1)+" max_bit1: "+str(max_bit1)
