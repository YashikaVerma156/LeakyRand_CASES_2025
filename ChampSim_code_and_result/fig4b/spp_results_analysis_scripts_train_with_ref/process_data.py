...
def process_files_in_directory(directory, benchmark_file):
    total_err_cnt=0
    for filename in os.listdir(directory):
       ...
       ######   Error calculation   ######
                        ...
                        for th in thresholds:
                            #XXX The below code is not correct for file remover, look into calculate_optimal_threshold/process_data.py for the correct code.
                            extracted_data_dir="extracted_data"
...
for directory in directories_to_process:
    if os.path.exists(directory):
      ...
      ##### Create a file for later use.
        ...
        process_files_in_directory(directory, benchmark_file)
