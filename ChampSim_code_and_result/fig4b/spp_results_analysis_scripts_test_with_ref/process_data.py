...
directories_to_process = ['sender_arr_size_3276', 'sender_arr_size_6554','sender_arr_size_9830', 'sender_arr_size_13108','sender_arr_size_16384']
...
for directory in directories_to_process:
    if os.path.exists(directory):
      ...
      ##### Create a file for later use.
        ...
        threshold_file_path="../spp_results_analysis_scripts_train_with_ref/calculate_optimal_threshold/temp_optimal_threshold_"+str(sender_array_size)+".txt"
        ...
        for file_path in files_to_delete:
            try:
                ...
                print(f"Failed to delete {file_path}: {e}")
        process_files_in_directory(directory, benchmark_file, threshold)
