...
#define SENDER_PAYS_SOCKET_LATENCY 0

#define EVERYONE_PAYS_SOCKET_LATENCY 0

#define SOCKET_LATENCY_WITH_SYNCHRONIZATION_OVERHEAD 0
...
extern int cycles_to_wait_for_before_triggering_clflush, cycles_to_wait_for_before_triggering_clflush_with_socket_latency;
