...
./script_for_err_corr_both_algo_2core_sender_access_and_flush_multiple_blocks_multiple_algo_itr_optimized.sh ${benchmark_test} ${arr_size} ${unroll_fact} ${algo_trigger_point} ${other_blocks} ${END_POINT} ${hit_miss_threshold} ${err_corr_iterations} ${sync_overhead} ${snd_skt_lat} ${evr_skt_lat}
...
#result_dir=/home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_sender_access_and_flush_multiple_blocks_LR_with_socket_latency/error_calculation/LR_experiments/LR_ERR_CORR_2core_results_both_algo_${err_corr_iterations}_access
result_dir=/home/yashikav/Desktop/Mirage_project/result_section5.5/LR_ERR_CORR_2core_results_both_algo_${err_corr_iterations}_access

mkdir -p /home/yashikav/Desktop/Mirage_project/result_section5.5/LR_ERR_CORR_2core_results_both_algo_${err_corr_iterations}_access
...
do
    ...
    do
            ...
            receiver_trace_path=/home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_sender_access_and_flush_multiple_blocks_LR_with_socket_latency/error_calculation/LR_experiments/pin_traces/${receiver_trace}
            ...
            sender_trace_path=/home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_sender_access_and_flush_multiple_blocks_LR_with_socket_latency/error_calculation/LR_experiments/sender_err_corr_both_algo_sender_access_and_flush_multiple_blocks/${sender_trace}

            ./run_2core_LR_ERR_CORR_both_algo.sh $sim_count $receiver_trace_path $sender_trace_path $seed $string_size $result_dir $binary_path ${sync_overhead} ${snd_skt_lat} ${evr_skt_lat} &
