...
unroll_fact_for_llc_occ_chk=2
string_size=23 #100 125 150 175 200
do_llc_occ_chk_at=20
max_arr_len=0
extra=0
extra_for_llc_occ_chk=0
trigger_extra_access_at=19
start_arr_addr=0
...
trigger_holes_at=20
do_err_corr_at=21 # 21 #20  #3 #4 #20  #XXX This can vary, but should be such that there is atleast a single increase in array length..
...
pin_files_path=../../pin-3.21-98484-ge7cd811fd-gcc-linux/source/tools/ManualExamples/binary_analysis
...
path_to_copy_trace=/home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_forward_fill_early_with_error_correction_with_LLC_occupancy_mediator/binary_analysis
...
./commands_sender_all_1.sh ${string_num} ${string_size} ${do_err_corr_at} ${trigger_holes_at} ${max_holes} ${trigger_extra_access_at} ${path_to_copy_trace}  
...
cd ../../../../../ChampSim_for_mirage_forward_fill_early_with_error_correction_with_LLC_occupancy_mediator/binary_analysis
...
./run_build_1core.sh ${sim_count_sender} ${trace_sender} ${string_size} ${seed} ${extra} ${extra_for_llc_occ_chk} ${start_arr_addr} ${max_arr_len}
...
exit  #XXX Read below script when you will run it by ommenting the exit here in this line.
...
other_blocks=326 # 19660  #326  #19659 #326 #19660 #327  #19659 #19660 #328 #19660 #327     #1638 #XXX edited it for testing purpose.
...
receiver_arr_size=259208 #104544 # 259232  #104568 #259232  #104552 #259248 #104560 #104316 #259232 #259304 #259336  #248848 #261048  #some number to start with.
...
echo "line 54, receiver array size is: ${receiver_arr_size} extra cache blocks are : ${extra} do_err_corr_at: ${do_err_corr_at}"
...
./run_build_1core.sh ${sim_count_receiver} ${trace_receiver} ${string_size} ${seed} ${extra} ${extra_for_llc_occ_chk} ${start_arr_addr} ${max_arr_len}
...
./run_build_2core.sh ${sim_count_sender} ${trace1} ${trace2} ${seed} ${string_size} ${extra} ${extra_for_llc_occ_chk} ${start_arr_addr} ${max_arr_len}
