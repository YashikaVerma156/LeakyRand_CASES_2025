...
#define FA_LRU_CACHE 0

#define DYNAMIC_ALGO_ITR 0

#define MAX_EXTRA_BLOCKS_POSSIBLE 1

#define CLEAR_CACHE_WITH_SKT_LAT 0

#define CLEAR_CACHE_WITH_SKT_LAT_SYN 0
...
extern int Calculate_LLC_occupancy, DONT_INC_ARR, fence_is_seen, Calculate_LLC_occupancy_dyn_algo;
...
extern int cycles_to_wait_for_before_triggering_clflush, cycles_to_wait_for_before_triggering_clflush_with_skt_lat, cycles_to_wait_for_before_triggering_clflush_with_skt_lat_sync;
