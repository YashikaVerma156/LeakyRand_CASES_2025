...
do
    ...
    do
            ...
            sender_trace=champsim.trace_sender_${string_size}_${STR_NUM}_${sim_count}.gz
            ./run_2core_LR_NO_ERR_CORR.sh $sim_count $receiver_trace $sender_trace $seed $string_size &
