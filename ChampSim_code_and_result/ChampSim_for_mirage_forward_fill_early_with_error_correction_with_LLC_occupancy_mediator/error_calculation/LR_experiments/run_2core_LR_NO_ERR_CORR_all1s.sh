...
do
	...
	(./binary/bimodal-no-no-${repl}-${CORE}core -warmup_instructions $warcount -simulation_instructions $simcount ${option} -random_seed ${seed} -traces $mix1 $mix2) > LR_NO_ERR_CORR_2core_results/result_${repl}_${CORE}_${trace1}_${trace2}_${string_num}_${benchmark_test}.txt
