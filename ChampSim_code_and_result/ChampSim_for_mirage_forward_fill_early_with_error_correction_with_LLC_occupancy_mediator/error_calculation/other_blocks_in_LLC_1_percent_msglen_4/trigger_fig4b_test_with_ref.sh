...
do
	...
	if [ ${binary_build} == 0 ]; then
	    ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_test.sh ${sender_arr_size} 100 ${START_POINT} 1
...
while read line; do
	...
	msg_num=$i
        ...
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_test.sh ${sender_arr_size_list[0]} ${seed} ${msg_num} 0 &
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_test.sh ${sender_arr_size_list[1]} ${seed} ${msg_num} 0 &
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_test.sh ${sender_arr_size_list[2]} ${seed} ${msg_num} 0 &
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_test.sh ${sender_arr_size_list[3]} ${seed} ${msg_num} 0 &
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_test.sh ${sender_arr_size_list[4]} ${seed} ${msg_num} 0 
