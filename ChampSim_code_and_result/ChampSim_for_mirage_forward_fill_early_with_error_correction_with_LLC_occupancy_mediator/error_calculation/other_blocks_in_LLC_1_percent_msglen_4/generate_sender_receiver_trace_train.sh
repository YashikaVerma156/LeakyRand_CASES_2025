...
mkdir -p sender_${sender_arr_size}_pin_trace_train
...
do
    ...
    cd ${pin_files_path} 
    ./commands_sender_all_1_seed_with_benchmark_suit_train.sh ${string_num} ${string_size} ${sender_arr_size} ${repetition_coding} ${differential_signalling} ${path_to_copy_trace}  
...
cd ${pin_files_path} 
./commands_receiver_all_1_seed_llc_sensitivity.sh ${receiver_arr_size} ${string_size} ${repetition_coding} ${differential_signalling} ${path_to_copy_trace} ${LLC_size}
