...
mkdir -p sender_${sender_arr_size}_pin_trace_test
...
do
    ...
    cd ${pin_files_path} 
    ./commands_sender_all_1_seed_with_benchmark_suit_test.sh ${string_num} ${string_size} ${sender_arr_size} ${repetition_coding} ${differential_signalling} ${path_to_copy_trace}  
