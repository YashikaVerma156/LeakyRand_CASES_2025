...
string_size=512  #512 #100 125 150 175 200  #XXX this needs to be set dynamically, remove the dependency of the folder name.
seed=7633  #24872  #36578 #24872  #7633
LLC_NUM_BLOCKS=32768
sender_arr_size_list=(3276) # 6554 9830 13108 16384) # (3276 6554 9830 13108 16384)  #8192  #32768  #16384 # 16384  #500
repetition_coding=1
differential_signalling=2

pin_files_path=../../../pin-3.21-98484-ge7cd811fd-gcc-linux/source/tools/ManualExamples/error_correction_and_occupancy_check_string_length_4
...
do
      ...
      sim_count_sender_arr+=(${sim_count_sender})
			...
			cd ../../../../../ChampSim_for_mirage_forward_fill_early_with_error_correction_with_LLC_occupancy_mediator/error_calculation/other_blocks_in_LLC_1_percent_msglen_4
...
receiver_arr_size=262144 # 259232  #104568 #259232  #104552 #259248 #104560 #104316 #259232 #259304 #259336  #248848 #261048  #some number to start with.
...
do
      ...
      #python3 collect_seed_results.py ${result_file} ${sender_arr_size} ${string_num} ${seed}
done
