...
path_to_copy_trace=/home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_forward_fill_early_with_error_correction_with_LLC_occupancy_mediator/error_calculation/other_blocks_in_LLC_1_percent_msglen_4/sender_${sender_arr_size}_pin_trace_train
trace1=champsim.trace_receiver_${string_size}_${LLC_size}_seed.gz
result_dir=/home/yashikav/Desktop/Mirage_project/fig4b/spp_results_analysis_scripts_train_with_ref/sender_arr_size_${sender_arr_size}
mkdir -p /home/yashikav/Desktop/Mirage_project/fig4b/spp_results_analysis_scripts_train_with_ref/sender_arr_size_${sender_arr_size}
...
trace2=champsim.trace_sender_${string_size}_${string_num}_${sim_count_sender}_arr_size_${sender_arr_size}_seed_train.gz
