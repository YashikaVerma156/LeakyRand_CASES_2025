...
do
	#echo "generated traces"
        ...
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_2mb_fig10_train.sh ${sender_arr_size} 100 ${START_POINT} 1 
done
#exit
j=${num_prl}
while read line; do
	...
	msg_num=$i
        ...
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_2mb_fig10_train.sh ${sender_arr_size_list[0]} ${seed} ${msg_num} 0 &
