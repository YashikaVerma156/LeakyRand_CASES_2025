...
then
    ...
    ./run_2core_fig10.sh ${sim_count} ${trace1} ${sender_trace} ${seed} ${string_size} 0 0 ${repetition_coding} ${differential_signalling} ${sender_arr_size} ${path_to_copy_trace} ${result_dir}
fi
