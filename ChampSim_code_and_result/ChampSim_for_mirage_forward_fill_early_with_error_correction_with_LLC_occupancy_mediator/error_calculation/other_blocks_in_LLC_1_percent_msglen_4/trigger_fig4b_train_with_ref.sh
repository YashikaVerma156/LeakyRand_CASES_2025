...
do
	#echo "generated traces"
        ./generate_sender_receiver_trace_train.sh ${sender_arr_size} ${START_POINT} ${STOP_POINT} 

	if [ ${binary_build} == 0 ]; then
	    ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_train.sh ${sender_arr_size} 100 ${START_POINT} 1
	    binary_build=`expr ${binary_build} + 1`
	fi
done
#exit
j=${num_prl}
while read line; do
	...
	msg_num=$i
        ...
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_train.sh ${sender_arr_size_list[0]} ${seed} ${msg_num} 0 &
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_train.sh ${sender_arr_size_list[1]} ${seed} ${msg_num} 0 &
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_train.sh ${sender_arr_size_list[2]} ${seed} ${msg_num} 0 &
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_train.sh ${sender_arr_size_list[3]} ${seed} ${msg_num} 0 &
        ./SPP_error_bandwidth_experiment_multiple_run_with_benchmark_suit_fig4b_train.sh ${sender_arr_size_list[4]} ${seed} ${msg_num} 0 
