...
for UF in UFs:
    for atp in Algo_trigger_point:
        ...
        if UF == 256:
            ...
            directory_path='../LR_ERR_CORR_2core_results_both_algo_'+str(err_corr_iterations)+'_access'
            file_list = os.listdir(directory_path)
        elif UF == 32 or UF == 64 or UF == 128:
            err_corr_iterations=15 #17 #14 #12 #Maximum number of times error-correction can be repeated.
            directory_path='../LR_ERR_CORR_2core_results_both_algo_'+str(err_corr_iterations)+'_access'
            file_list = os.listdir(directory_path)
