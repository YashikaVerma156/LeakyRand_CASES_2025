...
directories_to_train = ['sender_arr_size_19660', 'sender_arr_size_4915','sender_arr_size_9830']
    ...
    if os.path.exists(result_dir):
        ...
        with open(min_max_range_fl,"r") as m_fl:
            for line in m_fl:
                ...
                min_bit0=int(line[7])
                max_bit0=int(line[9])
            if min_bit0 < min_bit1 :
                threshold_start=(min_bit0-1)
            elif min_bit1 < min_bit0:
                threshold_start=(min_bit1-1)
            if max_bit1 < max_bit0 :
                threshold_end=(max_bit0+1)
            elif max_bit0 < max_bit1:
