...
./trigger_LR_WITH_ERR_CORR_both_algo_with_benchmark_suit_sender_access_and_flush_multiple_blocks.sh ${unroll_fact} ${START_POINT} ${END_POINT} ${num_prl} ${benchmark_test} ${string_size} ${other_blocks} ${arr_size} ${algo_trigger_point} ${hit_miss_threshold}
