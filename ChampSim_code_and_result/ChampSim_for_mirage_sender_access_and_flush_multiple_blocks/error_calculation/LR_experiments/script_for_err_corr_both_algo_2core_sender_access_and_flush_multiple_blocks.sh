...
cd ${pin_files_path} 
./commands_sender_LR_ERR_CORR_both_algo_with_benchmark_suit_multiple_access.sh ${string_num} ${string_size} ${do_err_corr_at} ${do_llc_occ_chk_at} ${path_to_copy_trace} ${benchmark_test}
...
then
    trace_sender=champsim.trace_sender_${string_size}_${string_num}_${sim_count_sender}_${do_err_corr_at}_with_both_algo_multiple_access_test.gz
else
    trace_sender=champsim.trace_sender_${string_size}_${string_num}_${sim_count_sender}_${do_err_corr_at}_with_both_algo_multiple_access_train.gz
fi
