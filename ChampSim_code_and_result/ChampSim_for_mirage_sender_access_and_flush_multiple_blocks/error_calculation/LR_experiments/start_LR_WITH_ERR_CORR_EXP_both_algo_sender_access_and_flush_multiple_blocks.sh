...
do
    ...
    do
        ...
        do
            ...
            ./calibration_and_variables_with_err_corr_both_algo_sender_access_and_flush_multiple_blocks.sh ${unroll_fact} ${algo_trigger_point} ${benchmark_test} ${other_blocks}
        done
    done
done
