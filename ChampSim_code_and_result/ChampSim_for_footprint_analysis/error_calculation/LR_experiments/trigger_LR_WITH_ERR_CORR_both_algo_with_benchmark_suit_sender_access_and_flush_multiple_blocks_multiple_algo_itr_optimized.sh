...
result_dir=/home/yashikav/Desktop/Mirage_project/new_covert_channel/ChampSim_for_mirage_new_covert_channel/error_calculation/LR_experiments/LR_ERR_CORR_2core_results_both_algo_${err_corr_iterations}_access
...
do
    ...
    do
            ...
            sender_trace_path=/home/yashikav/Desktop/Mirage_project/new_covert_channel/ChampSim_for_mirage_new_covert_channel/error_calculation/LR_experiments/sender_err_corr_both_algo_sender_access_and_flush_multiple_blocks/${sender_trace}
