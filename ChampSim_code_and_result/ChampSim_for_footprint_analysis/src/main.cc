...
int CURR_ERR_CORR_ITR = 0, MISSES_OBSERVED = 0, ERROR_CORRECTION_PHASE_LAST = 0, BIT_REVEALED_LAST = 0, CURR_LLC_OCC_CHK_ITR =0, ITR_TO_FILL_HOLE=0, NUM_CHUNKS_WITH_MISSES = 0, RECEIVER_COMPLETED_ONCE = 0;
		...
		bit_revealed_is=0; 
                          ...
                          {  
                              if(i == 1)
                              {
                                   ...
                                   {   
                                       ...
                                       RECEIVER_COMPLETED_ONCE ++; // This is used to end simulation early.
                                       cout << "RECEIVER_COMPLETED_ONCE: "<<RECEIVER_COMPLETED_ONCE <<endl;
                                   }
                                   receiver_checks_for_a_miss = 0; 
                                   bit_revealed_is=0;
          ...
          /*  // check for warmup
            ...
            */
            ...
            if (all_simulation_complete == NUM_CPUS || RECEIVER_COMPLETED_ONCE == 2)
                run_simulation = 0;
        }
