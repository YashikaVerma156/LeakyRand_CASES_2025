...
uint64_t counting_instr_for_ipc = 0, start_IO_cycle = 0, Total_IO_instr = 0, IO_instruction_end = 0, IO_instruction_start = 0, Total_cycles_spent_in_IO = 0, seen_fence_once = 0, Total_IO_miss = 0, IO_miss;
...
void cache_line_flush(int cpu, int clflush_address_num)
{
  ...
  //if(DETAILED_PRINT || CHANNEL_BW_ERR_PRINT || LR_NO_ERR_CORR || LR_ERR_CORR_BOTH_ALGO)
  {
      ...
      cout << "clflush called on cpu: "<< cpu<<" cpu_cycle: " <<current_core_cycle[cpu]<< " address: "<<hex<<clflush_on_cpu[cpu][num] <<" address>>12: "<<(clflush_on_cpu[cpu][num]>>12)<<" address>>6: "<<(clflush_on_cpu[cpu][num]>>6)<<" clflush_address_num: "<<clflush_address_num<<dec<<endl;
...
cout << "Spills: "<< spills << endl;
 ...
 cout <<"Total_IO_instr: "<<Total_IO_instr<<" Total_cycles_spent_in_IO: "<<Total_cycles_spent_in_IO<<" Calculated IPC: "<<((float)Total_IO_instr/Total_cycles_spent_in_IO)<<endl;
