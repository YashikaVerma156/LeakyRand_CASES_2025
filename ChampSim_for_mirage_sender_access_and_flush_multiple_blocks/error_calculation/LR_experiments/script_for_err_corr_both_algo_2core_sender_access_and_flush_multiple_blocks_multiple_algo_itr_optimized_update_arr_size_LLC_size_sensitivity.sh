...
if [ "$#" -ne 9 ]; then
    ...
    echo "Inside script_for_err_corr_both_algo_2core_sender_access_and_flush_multiple_blocks_multiple_algo_itr_optimized_update_arr_size_LLC_size_sensitivity.sh"
    exit 1
fi
