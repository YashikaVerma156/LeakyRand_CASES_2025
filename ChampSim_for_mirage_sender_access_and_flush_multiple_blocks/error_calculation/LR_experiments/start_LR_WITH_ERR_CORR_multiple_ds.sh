		...
		do
				...
				do
						...
						do
		                                     ...
		                                     echo "====================RUNNING FOR unroll_fact: ${unroll_fact}, algo_trigger_point: ${algo_trigger_point}, benchmark_test: ${benchmark_test} other_blocks: ${other_blocks} ======================="   
                                                     #exit 1 
		                                     ./calibration_multiple_ds.sh ${unroll_fact} ${algo_trigger_point} ${benchmark_test} ${other_blocks} ${err_corr_iterations} ${num_prl}
						done
				done
		done
done
                ...
                do
                                ...
                                do
                                                for algo_trigger_point in 128
                                                do
                                                        for  err_corr_iterations in 1 3 6 9 12
							do
