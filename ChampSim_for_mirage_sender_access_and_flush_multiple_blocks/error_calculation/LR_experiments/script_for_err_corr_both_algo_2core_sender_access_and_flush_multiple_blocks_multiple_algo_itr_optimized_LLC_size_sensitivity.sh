...
if [ "$#" -ne 9 ]; then
    echo "Appropriate number of arguments not passed, exiting from script_for_err_corr_both_algo_2core_sender_access_and_flush_multiple_blocks_multiple_algo_itr_optimized_LLC_size_sensitivity.sh. $#"
