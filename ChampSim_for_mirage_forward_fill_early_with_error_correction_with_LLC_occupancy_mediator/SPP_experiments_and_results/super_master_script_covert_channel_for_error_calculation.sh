...
./run_build_1core.sh ${sim_count_sender} ${trace_sender} ${string_size} ${seed} ${extra} ${max_arr_len}
...
other_blocks=19660  #326  #19659 #326 #19660 #327  #19659 #19660 #328 #19660 #327     #1638 #XXX edited it for testing purpose.
...
receiver_arr_size=104472 # 259232  #104568 #259232  #104552 #259248 #104560 #104316 #259232 #259304 #259336  #248848 #261048  #some number to start with.
...
do
  ...
  ./run_build_1core.sh ${sim_count_receiver} ${trace_receiver} ${string_size} ${seed} ${extra} ${max_arr_len}
...
./run_build_2core.sh ${sim_count_sender} ${trace1} ${trace2} ${seed} ${string_size} ${extra} ${max_arr_len}
