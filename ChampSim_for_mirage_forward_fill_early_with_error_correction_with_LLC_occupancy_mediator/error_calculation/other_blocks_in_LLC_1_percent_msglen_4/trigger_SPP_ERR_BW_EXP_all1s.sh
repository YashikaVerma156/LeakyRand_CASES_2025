...
do
    ...
    #done
        ...
        ./SPP_error_bandwidth_experiment_multiple_run_all1s.sh ${sender_arr_size_list[0]} ${seed} ${msg_num} &
        ./SPP_error_bandwidth_experiment_multiple_run_all1s.sh ${sender_arr_size_list[1]} ${seed} ${msg_num} &
        ./SPP_error_bandwidth_experiment_multiple_run_all1s.sh ${sender_arr_size_list[2]} ${seed} ${msg_num} &
        ./SPP_error_bandwidth_experiment_multiple_run_all1s.sh ${sender_arr_size_list[3]} ${seed} ${msg_num} &
        ./SPP_error_bandwidth_experiment_multiple_run_all1s.sh ${sender_arr_size_list[4]} ${seed} ${msg_num}
