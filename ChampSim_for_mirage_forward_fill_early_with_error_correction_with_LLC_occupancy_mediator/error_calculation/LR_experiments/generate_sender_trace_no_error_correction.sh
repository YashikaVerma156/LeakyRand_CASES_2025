...
path_to_copy_trace=/home/yashikav/Desktop/Mirage_project/ChampSim_for_mirage_forward_fill_early_with_error_correction_with_LLC_occupancy_mediator/error_calculation/LR_experiments/sender_test_benchmark_traces
...
./run_build_1core_to_generate_sender_traces.sh ${sim_count_sender} ${trace_sender} ${string_size} ${seed}
