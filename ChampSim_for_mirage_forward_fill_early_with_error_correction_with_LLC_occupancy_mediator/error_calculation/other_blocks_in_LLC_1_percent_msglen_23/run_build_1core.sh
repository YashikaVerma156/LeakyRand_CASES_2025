...
do
	...
	(./bin/bimodal-no-no-${repl}-${CORE}core -warmup_instructions $warcount -simulation_instructions $simcount ${option} -random_seed ${seed}  -traces $mix1) > error_calculation/other_blocks_in_LLC_1_percent_msglen_23/result_${repl}_${CORE}_${trace1}.txt
