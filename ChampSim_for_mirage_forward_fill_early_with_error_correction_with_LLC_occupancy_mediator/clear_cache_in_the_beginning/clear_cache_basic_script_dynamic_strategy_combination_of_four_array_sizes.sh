...
if [ "$#" -ne 8 ]; then
    echo "Usage: $0 <mid_number1> <arr_num_itr_mid_1> <mid_number2> <arr_num_itr_mid_2> <mid_number3> <arr_num_itr_mid_3> <arr_sizes> <arr_num_itr>"
    echo "The inputs should match the dynamic sequence generated from dynamic algo."
    echo "for example: <  ./clear_cache_basic_script_dynamic_strategy_combination_of_three_array_sizes.sh 1 1 1.1 1 1.2 1 1.3 8 >  : 1.1 1 means 1.1x of LLC and 1 iterations of 1.1x"
    exit 1
fi
