...
set output "sender-receiver-lr-cdf-test.eps"
set multiplot
...
set xtics 500
set grid
plot 'cdf_output_sender_test_absolute.txt' u 1:2 title "Sender" w linespoints lw 8 pt 2 ps 3 lc rgb "#0000FF"
...
set grid
plot 'cdf_output_receiver_test_absolute.txt' u 1:2 every 3 title "Receiver" w linespoints lw 8 pt 1 ps 3 lc rgb "#FF0000" axes x1y2
